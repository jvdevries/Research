...
{
    /// <summary>
    /// Represents an <see cref="IEnumerable"/> axis (i.e. an ordered collection of comparable values). Instantiation is done by means of <see cref="Create"/> methods.
    /// </summary>
    public abstract class Axis : IEnumerable
    {
        ...
        /// <summary>
        /// Instantiates a <see cref="Axis"/> with values whose Type are <see cref="unmanaged"/>, <see cref="IComparable"/>, and <see cref="IComparable{T}"/>.
        /// </summary>
