...
public class Program
{
    ...
    void Thread1()
    {
        ...
        Thread.VolatileWrite(ref X, 1);
        Thread.VolatileWrite(ref r1, Thread.VolatileRead(ref X));
        Thread.VolatileWrite(ref r2, Thread.VolatileRead(ref Y));
    }
    ...
    void Thread2()
    {
        ...
        Thread.VolatileWrite(ref Y, 1);
        Thread.VolatileWrite(ref r3, Thread.VolatileRead(ref Y));
        Thread.VolatileWrite(ref r4, Thread.VolatileRead(ref X));
    }
